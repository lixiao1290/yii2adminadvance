...
<form name="form1" id="form1" method="post" action="index.php?r=test/details">
  ...
  <div class="container">
    ...
    <div class="row" style="margin-top:20px;" id="row2">
      <div class="col-xs-12">
        <div class="form-group">
          <label class="text-muted">违反路标</label>
          <select class="form-control" name="type" id="hpzl2">
            <option value="01">超速行驶</option>
            <option value="02">违规停车</option>
            <option value="03">未按车道行驶</option>
            <option value="04">违反信号灯</option>
          </select>
        </div>
        <div class="form-group">
        <div class="form-group">
          <label class="text-muted">城市名称</label>
          <input class="form-control" type="text" name="cityName" id="clsbdh2" placeholder="请输入城市名称" autofocus required="" tabindex="2"/>
        </div>
        <div class="btn_div">
