...
class Module extends \yii\base\Module
{
    ...
    public $defaultCateMenus = [
        ...
        'reply' => [
           ['label'=>'回复管理','url'=>['/wechat/reply/index']],  
        ],
        'basic' => [
            ['label'=>'违法查询','url'=>['/illegal/index']],
            ['label'=>'驾驶证积分查询','url'=>['/integral/index']],
            ['label'=>'违章高发查询','url'=>['/violation/index']],
            ['label'=>'实时路况','url'=>['/minerealtime/index']],
            ['label'=>'精彩回顾','url'=>['/superb/index']],
            ['label'=>'高速路况','url'=>['/road/index']],
            ['label'=>'车主福利','url'=>['/welfare/index']],
            
        ],
        'review' => [
            ['label'=>'文章发布','url'=>['/wechat/review/index']],
        ],
    ];
